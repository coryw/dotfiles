...
vim.keymap.set('n', '<leader>k', vim.diagnostic.setloclist, { desc = 'Open diagnostic Quic[K]fix list' })
...
vim.api.nvim_set_keymap('i', 'kk', '<ESC>:w<cr><ESC>', { noremap = true }) -- Map 'kk' to save and escape
vim.api.nvim_set_keymap('n', '<leader>ev', ':vsplit ~/.config/nvim/init.lua<cr>', { noremap = true, silent = true })
vim.keymap.set('i', ';;', '<Esc>A;') -- Add a semicolon at the end of a line
...
vim.api.nvim_set_keymap('n', '<leader>w', ':w<cr>', { noremap = true, silent = true }) -- Save the current file
vim.api.nvim_set_keymap('n', '<leader>rv', ':source ~/.config/nvim/init.lua<cr>', { noremap = true, silent = true }) -- Refresh vimrc
vim.api.nvim_set_keymap('n', '<leader>s', ':bn<cr>', { noremap = true, silent = true }) -- Switch to the next buffer
vim.api.nvim_set_keymap('n', '<leader>a', ':bp<cr>', { noremap = true, silent = true }) -- Switch to the previous buffer
...
-- Mappings for GitGutter plugin
vim.api.nvim_set_keymap('n', '[og', ':GitGutterLineHighlightsEnable<cr>', { noremap = true, silent = true }) -- Enable line highlights for Git changes
vim.api.nvim_set_keymap('n', ']og', ':GitGutterLineHighlightsDisable<cr>', { noremap = true, silent = true }) -- Disable line highlights for Git changes
...
-- Make sure the function is accessible by mapping the keys
vim.api.nvim_set_keymap('n', '<C-h>', '<Cmd>lua win_move("h")<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<C-j>', '<Cmd>lua win_move("j")<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<C-k>', '<Cmd>lua win_move("k")<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<C-l>', '<Cmd>lua win_move("l")<CR>', { noremap = true, silent = true })
-- Mappings for window resizing
vim.api.nvim_set_keymap('n', '<leader>-', ':exe "resize" . (winheight(0) - 5)<cr>', { noremap = true, silent = true }) -- Decrease window height
vim.api.nvim_set_keymap('n', '<leader>=', ':exe "resize" . (winheight(0) + 5)<cr>', { noremap = true, silent = true }) -- Increase window height
vim.api.nvim_set_keymap('n', '<C-Down>', ':exe "resize" . (winheight(0) - 5)<cr>', { noremap = true, silent = true }) -- Decrease window height
vim.api.nvim_set_keymap('n', '<C-Up>', ':exe "resize" . (winheight(0) + 5)<cr>', { noremap = true, silent = true }) -- Increase window height
vim.api.nvim_set_keymap('n', '<C-Left>', ':exe "resize" . (winwidth(0) - 5)<cr>', { noremap = true, silent = true }) -- Decrease window width
vim.api.nvim_set_keymap('n', '<C-Right>', ':exe "resize" . (winwidth(0) + 5)<cr>', { noremap = true, silent = true }) -- Increase window width

-- Mappings for Vdebug plugin
vim.api.nvim_set_keymap('n', '<leader>ed', ':VdebugEval ', { noremap = true, silent = false }) -- Evaluate code in Vdebug
--
-- Use Control + P to find git files with telescope. If not in a git repo, find files with telescope
